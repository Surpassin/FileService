  ...
  return (
    <aside className="w-64 h-screen bg-dark-1 border-r border-dark-4 flex flex-col fixed left-0 top-0">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 ${
                isActive
                  ? 'bg-omnii-600/15 text-omnii-400 border border-omnii-600/20'
                  : 'text-surface-400 hover:text-surface-200 hover:bg-dark-3'
              }`}
            >
              {item.icon}
              {item.label}
      ...
      <div className="p-4 border-t border-dark-4">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-surface-500 hover:text-surface-300 hover:bg-dark-3 transition-colors duration-150"
        >
